...
class UpdateExpenditure extends StatefulWidget {
  ...
  @override
  _UpdateExpenditureState createState() => new _UpdateExpenditureState();
}
...
class _UpdateExpenditureState extends State<UpdateExpenditure> {
  ...
  List<TextEditingController> _expenditureControllers = [];
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse.containsKey('error')) {
          ...
          setState(() {
            ...
            controller.clustersList![index]['spendAmount'] =
                          ...
                          if (selectedLocation != null) {
                            ...
                            if (selectedLocationId != null) {
                              ...
                              setState(() {
                                ...
                                _expenditureControllers = List.generate(
                                  controller.clustersList?.length ?? 1,
                              ...
                              if (controller.clustersList!.length < 1) {
                                setState(() {
                                  controller.clustersList = null;
                                });
                              }
                                    ...
                                    SizedBox(
                                      ...
                                      child: TextField(
                                        ...
                                        onChanged: (newValue) {
                                          ...
                                          _updateExpenditure(index, newValue);
                                        },
