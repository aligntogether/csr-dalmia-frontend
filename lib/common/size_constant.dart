...
class MySize {
  ...
  static double getScaledSizeWidth(
    double size,
  ) {
    return kIsWeb ? size : (size * scaleFactorWidth);
  }

  static double getScaledSizeHeight(
    double size,
  ) {
    return kIsWeb ? size : (size * scaleFactorHeight);
  }
}
...
class Spacing {
  ...
  static EdgeInsetsGeometry left(
    double spacing,
  ) {
    return Spacing.only(
      left: spacing,
  ...
  static EdgeInsetsGeometry nLeft(
    double spacing,
  ) {
    return Spacing.only(
      top: spacing,
  ...
  static EdgeInsetsGeometry nTop(
    double spacing,
  ) {
    return Spacing.only(
      left: spacing,
  ...
  static EdgeInsetsGeometry nRight(
    double spacing,
  ) {
    return Spacing.only(
      top: spacing,
  ...
  static EdgeInsetsGeometry nBottom(
    double spacing,
  ) {
    return Spacing.only(
      top: spacing,
